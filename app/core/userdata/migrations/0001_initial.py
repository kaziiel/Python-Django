    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('DescHabil', ckeditor.fields.RichTextField(max_length=2000, verbose_name='Descripción de la habilidad')),
            ],
        ),
        migrations.CreateModel(
            name='Roles',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idRole', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userdata.Roles')),
                ('idUser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='userdata.DatosUser')),
            ],
        ),
    ]
